...
def public_pages():
    # NOTE: These pages are not yet implemented in this deployment.
    # Add page files to frontend/pages/config/ and frontend/pages/data/ to enable them.
    # For now, returning empty dict to prevent deployment errors.
    return {
        # "Config Generator": [
...
def private_pages():
    # NOTE: These pages require authentication and are not yet implemented.
    # Add page files to frontend/pages/orchestration/ to enable them.
    # For now, returning empty dict to prevent deployment errors.
    return {
        # "Bot Orchestration": [
