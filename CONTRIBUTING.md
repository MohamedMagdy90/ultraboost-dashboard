...
We appreciate and value your contribution to the UltraBoost Dashboard Repository. The following guidelines will help you contribute effectively and ensure consistency and quality across the project.
## General Workflow
1. Fork the `ultraboost-dashboard` repository.
...
5. The BoostNova team will review and test your code changes.
6. Address any changes requested by your reviewer, fix issues raised, and push your fixes as a single new commit.
7. A member of the BoostNova team will merge your pull request once it has been reviewed and accepted.
## Detailed Workflow
### 1. Fork the Repository
Fork the repository using GitHub's interface. Add the UltraBoost repository as an upstream remote and fetch the upstream data:
```bash
git remote add upstream https://github.com/MohamedMagdy90/ultraboost-dashboard.git
git fetch upstream
```
...
Create a pull request from your fork and branch to the upstream `main` branch, detailing your changes. Remember to check 'Allow edits by maintainers' for the team to update your branch when needed.
If changes are requested, make more commits to your branch to address these, then follow this process again from rebasing onwards. After addressing the requests, request further review.
## Checklist
